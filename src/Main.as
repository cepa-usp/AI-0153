...
*/			
		...
		function drop(e:MouseEvent) :void {
			...
			if (alvo.name == "cultura1") {
				cauleUm = cultura[dragging][0];
				raizUm = cultura[dragging][1];
				//cauleUm = new (getDefinitionByName(getQualifiedClassName(cauleUm)));
				addChild(cauleUm);
				addChild(raizUm);
			...
			if (alvo.name == "cultura2") {
				cauleDois = cultura[dragging][0];
				raizDois = cultura[dragging][1];
				addChild(cauleDois);
				addChild(raizDois);
